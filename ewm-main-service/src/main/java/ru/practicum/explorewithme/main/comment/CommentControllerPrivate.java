...
import ru.practicum.explorewithme.main.comment.dto.ResponseEventComment;
...
public class CommentControllerPrivate {
    ...
    public ResponseEventComment createCommentPrivate(@PathVariable("userId") Long userId,
    ...
    public ResponseEventComment updateCommentPrivate(@PathVariable("userId") Long userId,
                                                     @PathVariable("eventId") Long eventId,
    ...
    public ResponseEventComment getCommentPrivate(@PathVariable("userId") Long userId,
                                                  @PathVariable("eventId") Long eventId,
                                                  @PathVariable("commentId") Long commentId) {
